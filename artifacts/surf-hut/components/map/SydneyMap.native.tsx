...
function makeInjectedJs(leafletUrl: string): string {
  ...
  function initMap(){
    ...
    try{
      ...
      L.tileLayer("https://server.arcgisonline.com/ArcGIS/rest/services/Ocean/World_Ocean_Base/MapServer/tile/{z}/{y}/{x}",{maxZoom:13,attribution:"ESRI Ocean Basemap"}).addTo(map);
...
const styles = StyleSheet.create({
  container: { flex: 1 },
  map: { flex: 1, backgroundColor: "#c8dce8" },
  centered: {
    flex: 1,
    alignItems: "center",
